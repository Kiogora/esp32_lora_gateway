...
U 1 1 5AC09295
P 5950 4450
F 0 "U3" H 5950 4600 60  0000 C CNN
F 1 "LM2596_MODULE" H 5950 4500 60  0000 C CNN
F 2 "lib_fp:LM2596_MODULE" H 5950 4450 60  0001 C CNN
F 3 "" H 5950 4450 60  0001 C CNN
F 4 "https://store.nerokas.co.ke/index.php?route=product/product&product_id=1083&search=lm2596&description=true" H 5950 4450 50  0001 C CNN "purchase page"
	1    5950 4450
	1    0    0    -1  
$EndComp
...
U 1 1 5AC119E2
P 4800 4800
F 0 "#PWR019" H 4800 4550 50  0001 C CNN
...
U 1 1 5ADD9BA8
P 5450 1700
F 0 "R3" H 5300 1750 50  0000 L CNN
F 1 "10k" V 5450 1650 50  0000 L CNN
...
U 1 1 5AED67E5
P 7450 4100
F 0 "JP18" H 7350 3900 50  0000 C CNN
F 1 "Jumper" H 7450 4000 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x02_P2.54mm_Vertical" H 7450 4100 50  0001 C CNN
...
U 1 1 5AFB0C79
P 7250 5900
F 0 "D2" V 7288 5783 50  0000 R CNN
F 1 "LED" V 7197 5783 50  0000 R CNN
F 2 "LED_SMD:LED_0805_2012Metric_Pad0.97x1.50mm_HandSolder" H 7250 5900 50  0001 C CNN
...
U 1 1 5AFC467F
P 7650 6150
F 0 "R6" V 7550 6150 50  0000 C CNN
F 1 "270R" V 7650 6150 50  0000 C CNN
...
U 1 1 5AFD876B
P 7950 6250
F 0 "#PWR041" H 7950 6000 50  0001 C CNN
...
Wire Wire Line
	7950 6150 7800 6150
Text Notes 5385 6535 0    50   ~ 0
Network status LED\n=================\nToggles once every 500ms for a network error. Check network interfaces.\nToggles once every 30 sec for a successful uplink report.
...
U 1 1 5B03C5B5
P 3850 4200
F 0 "J8" H 3500 4250 50  0000 C CNN
F 1 "Jack-DC" H 3600 4150 50  0000 C CNN
F 2 "Connector_BarrelJack:BarrelJack_Horizontal" H 3900 4160 50  0001 C CNN
F 3 "https://www.cui.com/product/resource/pj-002a.pdf" H 3900 4160 50  0001 C CNN
F 4 "https://www.digikey.com/product-detail/en/cui-inc/PJ-002A/CP-002A-ND/96962" H 3850 4200 50  0001 C CNN "purchase page"
	1    3850 4200
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5B1637D0
P 7500 4400
F 0 "JP20" H 7400 4200 50  0000 C CNN
F 1 "Jumper" H 7450 4300 50  0000 C CNN
F 2 "Connector_PinSocket_2.54mm:PinSocket_1x02_P2.54mm_Vertical" H 7500 4400 50  0001 C CNN
